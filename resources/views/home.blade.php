...
@section('content')
    ...
    <div class="page-content">
        ...
        <div class="section-full bg-white content-inner-1"
             style="background-image: url('https://autocare.dexignlab.com/xhtml/images/bg-img.png'); background-repeat: repeat-x; background-position: left bottom -37px;">
            <div class="container">
                <div class="row">
                    <div class="col-lg-7 about-contant">
                        ...
                        <p class="m-b30">Hay muchas variaciones de los pasajes de Lorem Ipsum disponibles, pero la
                            mayoría sufrió alteraciones en alguna manera, ya sea porque se le agregó humor, o palabras
                            aleatorias que no parecen ni un poco creíbles. Si vas a utilizar un pasaje de Lorem Ipsum,
                            necesitás estar seguro de que no hay nada avergonzante escondido en el medio del texto.
                            Todos los generadores de Lorem Ipsum que se encuentran en Internet tienden a repetir trozos
                        ...
                        <p class="m-b15">Lorem Ipsum es simplemente el texto de relleno de las imprentas y archivos de
